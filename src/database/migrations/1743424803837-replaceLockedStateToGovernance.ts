...
export class ReplaceLockedStateToGovernance1743424803837 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."vaults_vault_status_enum" AS ENUM('draft', 'published', 'contribution', 'investment', 'locked', 'governance')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "vault_tags" DROP CONSTRAINT "FK_adf9f0b047319be1ec67ac1d1eb"`);
        await queryRunner.query(`ALTER TABLE "vault_tags" DROP CONSTRAINT "FK_2b3fd4667b2be7a2d7a329083cc"`);
        await queryRunner.query(`CREATE TYPE "public"."vaults_vault_status_enum_old" AS ENUM('draft', 'published', 'contribution', 'investment', 'locked')`);

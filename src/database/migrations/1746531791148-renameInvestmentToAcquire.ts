...
export class RenameInvestmentToAcquire1746531791148 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "acquirer_whitelist" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "wallet_address" character varying NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "vault_id" uuid, CONSTRAINT "PK_b77867938d64c2d82cef966008f" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "vaults" DROP COLUMN "ft_investment_reserve"`);
        await queryRunner.query(`ALTER TABLE "vaults" DROP CONSTRAINT "REL_3e6ff48532fbe552bbb6c4098b"`);
        await queryRunner.query(`ALTER TABLE "vaults" DROP COLUMN "investors_whitelist_csv_id"`);
        await queryRunner.query(`ALTER TABLE "vaults" DROP COLUMN "investment_phase_start"`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."vaults_acquire_open_window_type_enum" AS ENUM('custom', 'upon-asset-window-closing')`);
        await queryRunner.query(`ALTER TABLE "vaults" ADD "acquire_open_window_type" "public"."vaults_acquire_open_window_type_enum"`);
        ...
        await queryRunner.query(`ALTER TABLE "vaults" ADD CONSTRAINT "UQ_c211339d9110a71f1e7b65d87b5" UNIQUE ("acquirer_whitelist_csv_id")`);
        await queryRunner.query(`ALTER TYPE "public"."transactions_type_enum" RENAME TO "transactions_type_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."transactions_type_enum" AS ENUM('mint', 'payment', 'contribute', 'acquire', 'investment', 'burn', 'swap', 'stake')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."vaults_vault_status_enum" AS ENUM('draft', 'created', 'published', 'contribution', 'acquire', 'investment', 'locked', 'governance')`);
        ...
        await queryRunner.query(`ALTER TABLE "vaults" ADD CONSTRAINT "FK_c211339d9110a71f1e7b65d87b5" FOREIGN KEY ("acquirer_whitelist_csv_id") REFERENCES "files"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."vaults_vault_status_enum_old" AS ENUM('draft', 'created', 'published', 'contribution', 'investment', 'locked', 'governance')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."transactions_type_enum_old" AS ENUM('mint', 'payment', 'contribute', 'investment', 'burn', 'swap', 'stake')`);
        ...
        await queryRunner.query(`ALTER TABLE "vaults" ADD CONSTRAINT "REL_3e6ff48532fbe552bbb6c4098b" UNIQUE ("investors_whitelist_csv_id")`);
        ...
        await queryRunner.query(`DROP TABLE "acquirer_whitelist"`);
        await queryRunner.query(`ALTER TABLE "vault_tags" ADD CONSTRAINT "FK_adf9f0b047319be1ec67ac1d1eb" FOREIGN KEY ("vault_id") REFERENCES "vaults"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "vault_tags" ADD CONSTRAINT "FK_2b3fd4667b2be7a2d7a329083cc" FOREIGN KEY ("tag_id") REFERENCES "tags"("id") ON DELETE CASCADE ON UPDATE CASCADE`);

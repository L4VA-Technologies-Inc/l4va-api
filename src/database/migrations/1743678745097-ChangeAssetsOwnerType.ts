...
export class ChangeAssetsOwnerType1743678745097 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "assets" ADD CONSTRAINT "FK_969c7c69dd286d6e17dedd27923" FOREIGN KEY ("added_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);

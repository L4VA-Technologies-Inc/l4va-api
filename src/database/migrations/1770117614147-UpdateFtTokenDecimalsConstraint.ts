...
export class UpdateFtTokenDecimalsConstraint1770117614147 implements MigrationInterface {
  name = 'UpdateFtTokenDecimalsConstraint1770117614147';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "vault_tags" DROP CONSTRAINT "FK_adf9f0b047319be1ec67ac1d1eb"`);
    await queryRunner.query(`ALTER TABLE "vault_tags" DROP CONSTRAINT "FK_2b3fd4667b2be7a2d7a329083cc"`);
    await queryRunner.query(`ALTER TABLE "vaults" DROP CONSTRAINT "CHK_7c37c9750c104b1621f294a09e"`);
    ...
    await queryRunner.query(
      `ALTER TABLE "vaults" ADD CONSTRAINT "CHK_9d2496e0bc2b30a41372df4bd4" CHECK (((ft_token_decimals >= 1) AND (ft_token_decimals <= 9)))`
    );
    await queryRunner.query(
      `ALTER TABLE "vault_tags" ADD CONSTRAINT "FK_2b3fd4667b2be7a2d7a329083cc" FOREIGN KEY ("tag_id") REFERENCES "tags"("id") ON DELETE CASCADE ON UPDATE CASCADE`
    );

...
export class AddDateForTransactions1762432530879 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."claims_type_enum" AS ENUM('lp', 'contributor', 'acquirer', 'l4va', 'final_distribution', 'cancellation', 'distribution')`);
        await queryRunner.query(`ALTER TABLE "claims" ALTER COLUMN "type" TYPE "public"."claims_type_enum" USING "type"::"text"::"public"."claims_type_enum"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "vault_tags" DROP CONSTRAINT "FK_adf9f0b047319be1ec67ac1d1eb"`);
        await queryRunner.query(`ALTER TABLE "vault_tags" DROP CONSTRAINT "FK_2b3fd4667b2be7a2d7a329083cc"`);
        await queryRunner.query(`CREATE TYPE "public"."claims_type_enum_old" AS ENUM('lp', 'contributor', 'acquirer', 'l4va', 'final_distribution', 'cancellation')`);
        await queryRunner.query(`ALTER TABLE "claims" ALTER COLUMN "type" TYPE "public"."claims_type_enum_old" USING "type"::"text"::"public"."claims_type_enum_old"`);

...
export class AddNewTypesAndStatusesToAssets1774265092945 implements MigrationInterface {
  name = 'AddNewTypesAndStatusesToAssets1774265092945';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "vault_tags" DROP CONSTRAINT "FK_2b3fd4667b2be7a2d7a329083cc"`);
    await queryRunner.query(
      `CREATE TYPE "public"."assets_origin_type_enum_old" AS ENUM('acquired', 'contributed', 'fee')`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."assets_status_enum_old" AS ENUM('pending', 'locked', 'released', 'distributed', 'extracted', 'listed', 'sold', 'burned')`
    );
    await queryRunner.query(`ALTER TABLE "assets" ALTER COLUMN "status" DROP DEFAULT`);
    await queryRunner.query(

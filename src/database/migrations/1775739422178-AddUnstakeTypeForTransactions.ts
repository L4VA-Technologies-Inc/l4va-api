...
export class AddUnstakeTypeForTransactions1775739422178 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "vault_tags" DROP CONSTRAINT "FK_2b3fd4667b2be7a2d7a329083cc"`);
    await queryRunner.query(
      `CREATE TYPE "public"."transactions_type_enum_old" AS ENUM('acquire', 'all', 'burn', 'cancel', 'claim', 'contribute', 'create-vault', 'distribute-lp', 'distribution', 'extract', 'extract-dispatch', 'extract-lp', 'investment', 'mint', 'payment', 'stake', 'swap', 'update-vault', 'wayup')`
    );
    await queryRunner.query(

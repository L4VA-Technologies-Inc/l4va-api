...
export class AddValuationMethodToAssetsWhitelist1771947575965 implements MigrationInterface {
  name = 'AddValuationMethodToAssetsWhitelist1771947575965';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "assets_whitelist" DROP COLUMN "custom_price_ada"`);
    await queryRunner.query(`ALTER TABLE "assets_whitelist" DROP COLUMN "valuation_method"`);
    await queryRunner.query(
      `ALTER TABLE "vault_tags" ADD CONSTRAINT "FK_2b3fd4667b2be7a2d7a329083cc" FOREIGN KEY ("tag_id") REFERENCES "tags"("id") ON DELETE CASCADE ON UPDATE CASCADE`
    );
    await queryRunner.query(

...
export class AddAssetListingFields1766482934272 implements MigrationInterface {
  name = 'AddAssetListingFields1766482934272';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "vault_tags" DROP CONSTRAINT "FK_adf9f0b047319be1ec67ac1d1eb"`);
    await queryRunner.query(`ALTER TABLE "vault_tags" DROP CONSTRAINT "FK_2b3fd4667b2be7a2d7a329083cc"`);
    await queryRunner.query(`ALTER TABLE "assets" ADD "listing_market" text`);
    await queryRunner.query(`ALTER TABLE "assets" ADD "listing_price" numeric(20,6)`);
    await queryRunner.query(`ALTER TABLE "assets" ADD "listing_tx_hash" text`);
    await queryRunner.query(`ALTER TABLE "assets" ADD "listed_at" TIMESTAMP WITH TIME ZONE`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "assets" DROP COLUMN "listed_at"`);
    await queryRunner.query(`ALTER TABLE "assets" DROP COLUMN "listing_tx_hash"`);
    await queryRunner.query(`ALTER TABLE "assets" DROP COLUMN "listing_price"`);
    await queryRunner.query(`ALTER TABLE "assets" DROP COLUMN "listing_market"`);
    await queryRunner.query(
      `ALTER TABLE "vault_tags" ADD CONSTRAINT "FK_2b3fd4667b2be7a2d7a329083cc" FOREIGN KEY ("tag_id") REFERENCES "tags"("id") ON DELETE CASCADE ON UPDATE CASCADE`
    );
    await queryRunner.query(

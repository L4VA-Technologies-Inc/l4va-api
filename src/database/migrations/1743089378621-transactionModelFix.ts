...
export class TransactionModelFix1743089378621 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."transactions_type_enum" AS ENUM('mint', 'payment', 'contribute', 'burn', 'swap', 'stake')`);
        await queryRunner.query(`CREATE TYPE "public"."transactions_status_enum" AS ENUM('created', 'pending', 'submitted', 'confirmed', 'failed', 'manual-review')`);
        ...
        await queryRunner.query(`ALTER TABLE "vaults" ALTER COLUMN "type" TYPE "public"."vaults_type_enum" USING "type"::"text"::"public"."vaults_type_enum"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "vaults" ALTER COLUMN "type" TYPE "public"."vaults_type_enum_old" USING "type"::"text"::"public"."vaults_type_enum_old"`);

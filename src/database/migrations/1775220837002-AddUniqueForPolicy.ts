...
export class AddUniqueForPolicy1775220837002 implements MigrationInterface {
  name = 'AddUniqueForPolicy1775220837002';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "token_verifications" ADD CONSTRAINT "UQ_d7f41361ad2c285bb5ee4635350" UNIQUE ("policy_id")`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "vault_tags" DROP CONSTRAINT "FK_adf9f0b047319be1ec67ac1d1eb"`);
    await queryRunner.query(`ALTER TABLE "vault_tags" DROP CONSTRAINT "FK_2b3fd4667b2be7a2d7a329083cc"`);
    await queryRunner.query(`ALTER TABLE "token_verifications" DROP CONSTRAINT "UQ_d7f41361ad2c285bb5ee4635350"`);

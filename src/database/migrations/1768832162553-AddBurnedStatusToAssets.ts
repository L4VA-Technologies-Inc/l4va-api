...
export class AddBurnedStatusToAssets1768832162553 implements MigrationInterface {
  name = 'AddBurnedStatusToAssets1768832162553';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."assets_status_enum" AS ENUM('pending', 'locked', 'released', 'distributed', 'extracted', 'listed', 'sold', 'burned')`
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."assets_status_enum_old" AS ENUM('distributed', 'extracted', 'listed', 'locked', 'pending', 'released', 'sold')`
    );
    await queryRunner.query(`ALTER TABLE "assets" ALTER COLUMN "status" DROP DEFAULT`);
    await queryRunner.query(

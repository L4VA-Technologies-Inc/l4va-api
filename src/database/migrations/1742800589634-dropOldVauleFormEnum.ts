...
export class DropOldVauleFormEnum1742800589634 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."vaults_contribution_open_window_type_enum" AS ENUM('custom', 'upon-vault-launch')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "vault_tags" DROP CONSTRAINT "FK_adf9f0b047319be1ec67ac1d1eb"`);
        await queryRunner.query(`ALTER TABLE "vault_tags" DROP CONSTRAINT "FK_2b3fd4667b2be7a2d7a329083cc"`);
        await queryRunner.query(`CREATE TYPE "public"."vaults_contribution_open_window_type_enum_old" AS ENUM('custom', 'upon-vault-lunch', 'upon-vault-launch')`);

...
export class AddTxHexToTransactions1753434122053 implements MigrationInterface {
  name = 'AddTxHexToTransactions1753434122053';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "vault_tags" DROP CONSTRAINT "FK_2b3fd4667b2be7a2d7a329083cc"`);
    await queryRunner.query(`ALTER TABLE "vault_tags" DROP CONSTRAINT "FK_adf9f0b047319be1ec67ac1d1eb"`);
    await queryRunner.query(`ALTER TABLE "transactions" ADD "tx_hex" character varying`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "transactions" DROP COLUMN "tx_hex"`);
    await queryRunner.query(

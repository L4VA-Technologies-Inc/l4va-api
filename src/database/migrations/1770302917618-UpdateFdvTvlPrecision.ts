...
export class UpdateFdvTvlPrecision1770302917618 implements MigrationInterface {
  name = 'UpdateFdvTvlPrecision1770302917618';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "vault_tags" DROP CONSTRAINT "FK_adf9f0b047319be1ec67ac1d1eb"`);
    await queryRunner.query(`ALTER TABLE "vault_tags" DROP CONSTRAINT "FK_2b3fd4667b2be7a2d7a329083cc"`);
    await queryRunner.query(`ALTER TABLE "vaults" ALTER COLUMN "fdv_tvl" TYPE numeric(12,6)`);
    ...
    await queryRunner.query(`CREATE INDEX "IDX_7420141b53a73420e9e7239c89" ON "claims" ("vault_id") `);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "vault_tags" DROP CONSTRAINT "FK_adf9f0b047319be1ec67ac1d1eb"`);
    await queryRunner.query(`ALTER TABLE "vault_tags" DROP CONSTRAINT "FK_2b3fd4667b2be7a2d7a329083cc"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_7420141b53a73420e9e7239c89"`);
    ...
    await queryRunner.query(`ALTER TABLE "vaults" ALTER COLUMN "fdv_tvl" TYPE numeric`);
    await queryRunner.query(
      `ALTER TABLE "vault_tags" ADD CONSTRAINT "FK_2b3fd4667b2be7a2d7a329083cc" FOREIGN KEY ("tag_id") REFERENCES "tags"("id") ON DELETE CASCADE ON UPDATE CASCADE`
    );
    await queryRunner.query(

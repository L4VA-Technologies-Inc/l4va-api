...
export class IncreaseUserGainsPrecision1767873586646 implements MigrationInterface {
  name = 'IncreaseUserGainsPrecision1767873586646';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "gains" TYPE numeric(20,2)`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "vault_tags" DROP CONSTRAINT "FK_adf9f0b047319be1ec67ac1d1eb"`);
    await queryRunner.query(`ALTER TABLE "vault_tags" DROP CONSTRAINT "FK_2b3fd4667b2be7a2d7a329083cc"`);
    await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "gains" TYPE numeric(10,2)`);

...
export class AddedTags1741943808652 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "vault_tags" ("tag_id" uuid NOT NULL, "vault_id" uuid NOT NULL, CONSTRAINT "PK_b43bcaa347028f52de05c137789" PRIMARY KEY ("tag_id", "vault_id"))`);

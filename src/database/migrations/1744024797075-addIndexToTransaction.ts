...
export class AddIndexToTransaction1744024797075 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "transactions" ADD CONSTRAINT "FK_f93b9856ae3dfe138275ad9d684" FOREIGN KEY ("vault_id") REFERENCES "vaults"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);

...
export class AddAbstainDefaultValue1757597734679 implements MigrationInterface {
  name = 'AddAbstainDefaultValue1757597734679';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "proposal" ALTER COLUMN "abstain" SET DEFAULT false`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "vault_tags" DROP CONSTRAINT "FK_adf9f0b047319be1ec67ac1d1eb"`);
    await queryRunner.query(`ALTER TABLE "vault_tags" DROP CONSTRAINT "FK_2b3fd4667b2be7a2d7a329083cc"`);
    await queryRunner.query(`ALTER TABLE "proposal" ALTER COLUMN "abstain" DROP DEFAULT`);

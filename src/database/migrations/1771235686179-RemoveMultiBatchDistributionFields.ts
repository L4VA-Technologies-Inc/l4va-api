...
export class RemoveMultiBatchDistributionFields1771235686179 implements MigrationInterface {
  name = 'RemoveMultiBatchDistributionFields1771235686179';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "vaults" ADD "pending_ada_distribution" jsonb`);
    await queryRunner.query(`ALTER TABLE "vaults" ADD "pending_multipliers" jsonb`);

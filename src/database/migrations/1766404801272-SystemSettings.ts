...
export class SystemSettings1766404801272 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "system_settings" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "data" jsonb NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_82521f08790d248b2a80cc85d40" PRIMARY KEY ("id"))`
    );

    // Insert default system settings if table is empty
    await queryRunner.query(`
      INSERT INTO system_settings (data, created_at, updated_at)
      SELECT 
        '{"protocol_enabled": false, "vlrm_creator_fee": 1000, "l4va_monthly_budget": 1000, "protocol_acquires_fee": 5000000, "vlrm_creator_fee_enabled": true, "protocol_contributors_fee": 5000000}'::jsonb,
        NOW(),
        NOW()
